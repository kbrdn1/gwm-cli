...
Since [#623](https://github.com/kbrdn1/gwm-cli/issues/623) the values sit in a
column of their own, right-aligned against the widest label rather than against
the panel's edge, and the shape of a value says what kind it is:
