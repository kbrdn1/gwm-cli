...
same labelled section rules the Settings panel wears, muted so they mark a
group without competing with what is in it. Chords render as flat accent-bold
glyphs and all colours follow the resolved `[theme]`.
