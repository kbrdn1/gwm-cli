...
row while filtering its header out) and hides the chevrons while it lasts. The
fold state is session-only: nothing persists it, and every group starts open.
