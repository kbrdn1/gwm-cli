...
Press `s` (rebindable as `toggle_sidebar_mode` in [`[tui.keys]`](/configuration/gwm-toml#tui-keys)) to toggle the Details panel between two modes. Added by [#34](https://github.com/kbrdn1/gwm-cli/issues/34) / [#166](https://github.com/kbrdn1/gwm-cli/pull/166).
