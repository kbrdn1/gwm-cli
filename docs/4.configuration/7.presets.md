...
description: gwm init --preset <stack> seeds an opinionated .gwm.toml for a known stack, with the six built-ins (laravel, node/nuxt, rust, go, python-uv, generic), what each seeds, --list-presets and --show.
navigation:
  title: Config presets
---
