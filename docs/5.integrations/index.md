...
- **[`gwm doctor`](/integrations/doctor)**: the 11 health checks, exit-code semantics (`0 / 1 / 2`), the launcher-binary probe added in v0.6, and the `[tui.keys]` keymap check added in v0.8.
