---
title: Roadmap
description: What's shipped — the v1.4.0 line (the complete help overlay and the TUI-polish trio on top of the agent-aware v1.3.0 and the frozen v1.0.0 contracts) — and the link to the issue tracker.
---
