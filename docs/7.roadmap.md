---
title: Roadmap
description: What's shipped — the v1.3.0 line (agent session detection, the Windows daemon transport, and the distribution train on top of the frozen v1.0.0 contracts) — and the link to the issue tracker.
---
...
- **Multi-forge** ([#419](https://github.com/kbrdn1/gwm-cli/issues/419)) — a `Forge` trait behind the GitHub surface, and a GitLab (`glab`) backend as its first second implementation.
...
- **TUI polish** ([#436](https://github.com/kbrdn1/gwm-cli/issues/436) / [#437](https://github.com/kbrdn1/gwm-cli/issues/437) / [#438](https://github.com/kbrdn1/gwm-cli/issues/438)) — a CI checks overlay in the Status context, Working Tree scrolling from the Status context, responsive sidebar heights.
