...
Depuis [#623](https://github.com/kbrdn1/gwm-cli/issues/623), les valeurs
occupent une colonne à part, alignée à droite sur le libellé le plus large et
non sur le bord du panneau, et la forme d'une valeur dit de quel type elle est :
