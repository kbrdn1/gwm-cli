...
Les deux colonnes se placent un espace après la **ligne la plus longue**, et
non contre la bordure de la surcouche. Celle-ci occupe 90 % de l'écran : une
colonne collée au bord mettrait la lettre à cent cellules du nom qu'elle
décrit, soit l'inverse de la colonne fixe recherchée. Leur position dépend
donc de la liste, pas du terminal : élargir la fenêtre ne les déplace pas.
