...
`t`, et c'est aussi de là que viennent ses refus : un onglet zellij ne porte
pas de commande, aucun des deux niveaux herdr non plus, et la barre de statut
nomme celui qui a dit non. La commande de reprise par backend est
