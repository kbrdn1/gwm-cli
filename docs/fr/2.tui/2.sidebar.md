...
Appuyez sur `s` (remappable comme `toggle_sidebar_mode` dans [`[tui.keys]`](/fr/configuration/gwm-toml#tui-keys)) pour basculer le panneau Détails entre deux modes. Ajouté par [#34](https://github.com/kbrdn1/gwm-cli/issues/34) / [#166](https://github.com/kbrdn1/gwm-cli/pull/166).
