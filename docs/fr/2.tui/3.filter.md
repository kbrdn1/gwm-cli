---
title: Filtre flou
description: La barre de filtre `/` — nucleo-matcher, filtres persistants, sémantique d'Esc.
---
...
- [Raccourcis clavier → vue liste](/fr/tui/keybindings#list-view-default) — chaque touche que la vue filtre écoute
