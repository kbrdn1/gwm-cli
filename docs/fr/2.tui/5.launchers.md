...
description: Sections `[git_tui]` et `[review]` — expansion des placeholders, overlay PTY embarqué vs plein écran, chaîne de résolution de la base.
---

# Lanceurs configurables (TUI git et review)
