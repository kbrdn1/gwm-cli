...
![La palette de commandes `:` filtrant les actions](../../2.tui/_assets/palette.png)
![L'onglet Keys du panneau Settings : l'éditeur de keymap en direct](../../2.tui/_assets/keymap.png)
