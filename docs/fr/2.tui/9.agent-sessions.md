...
![La surcouche des sessions d'agents : une ligne par session avec l'agent, sa fraîcheur, sa dernière activité et son nom](../../2.tui/_assets/agent-sessions.png)
