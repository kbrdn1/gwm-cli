...
| Flag               | Action                                                                |
|:-------------------|:---------------------------------------------------------------------|
| `--profile <nom>`  | Récupère le jeu de répertoires [`[clean.profiles.<nom>]`](/configuration/gwm-toml#exec-and-clean) — un jeu **complet** qui remplace les intégrés (un nom inconnu sort en `1`) |
