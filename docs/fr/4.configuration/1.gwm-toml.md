...
| Signal de focus | texte + aplat de l'en-tête (`selection_bg` si focalisé, `section_bg` sinon), et le corps du panneau inactif est atténué | couleur du filet |
...
Une valeur inconnue est une **erreur de config au chargement**.
