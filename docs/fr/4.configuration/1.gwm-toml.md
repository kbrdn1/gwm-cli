...
Une valeur inconnue est une **erreur de config au chargement**. `layout` et `dim_unfocused` sont aussi exposés dans le panneau Settings sous l'onglet **TUI** (`4`), où faire défiler le choix s'applique à chaud.
