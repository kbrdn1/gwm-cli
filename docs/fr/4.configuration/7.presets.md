...
description: gwm init --preset <stack> génère un .gwm.toml clé en main pour une stack connue, avec les six presets intégrés (laravel, node/nuxt, rust, go, python-uv, generic), ce que chacun installe, --list-presets et --show.
navigation:
  title: Presets de configuration
---
...
de fichier propre : son corps *est* [`examples/gwm.toml.example`](https://github.com/kbrdn1/gwm-cli/blob/main/examples/gwm.toml.example),
