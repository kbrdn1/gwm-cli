...
![Le panneau Issue·PR avec une issue auto-liée et une PR ouverte détectée via gh](../../5.integrations/_assets/github-linking.png)
...
Les branches suivant la convention de nommage gwm `<type>/#<N>-<slug>` déduisent le numéro d'issue à partir du nom de branche, sans configuration nécessaire.
...
1. un `gwm link pr` explicite (`gwm-pr`), qui l'emporte toujours,
