...
- **`!`** : au moins un mot-clé n'est pas reconnu (Avertissement, pas Échec, car la commande fautive s'exécute quand même, en se rabattant sur `true`)
