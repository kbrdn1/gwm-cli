...
- **Il laisse l'en-tête `[branch "…"]` vide derrière lui.** libgit2 supprime les clés, pas la section, donc une branche qui portait sept clés tombe à une ligne et non à zéro. Sur un dépôt greffé à 1434 lignes, purger 869 clés a ramené le fichier à 561, pas à 13.
