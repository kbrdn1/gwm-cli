...
Les numéros ci-dessous nomment les vérifications ; ce n'est pas l'ordre dans lequel le rapport les imprime, qui est celui de `doctor::run`.
...
### 10. pas de config de branche orpheline
